...
if(isset($_POST['submit']))
{
	...
	{
		header("Location: ../views/page_updateBillAddress.php?updateAdd=empty");
		exit();
	}
	...
	else
	{
		...
		$bdid = $add['id'];
		$object->updateBillAddress($bdid, $uid);
...
{
	header("Location: ../views/page_updateBillAddress.php?updateAdd=error");
	exit();	
}